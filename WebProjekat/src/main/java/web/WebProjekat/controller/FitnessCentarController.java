...
public class FitnessCentarController {
    ...
    @GetMapping(value = "/centri", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value= "/centri",consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value="/centri/{id}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
